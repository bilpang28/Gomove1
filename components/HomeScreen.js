...
export const HomeScreen = () => {
  ...
  const DATA = [
    ...
    },
    {
      ...
      imagesrc:mrt,
      onPressHandler:()=>{
        nav.navigate("schedule",{title:"Taxi",imagesrc:mrt,backgroundColor:"#3A9EC2"});
      }
    },
    {
      id: 4,
      ...
      imagesrc:mrt,
      onPressHandler:()=>{
        nav.navigate("schedule",{title:"Ferry",imagesrc:mrt,backgroundColor:"#3A9EC2"});
      }
    }
  ];
          ...
          <View style={styles.container}>
              <View style={styles.topview}>
                  <View style={styles.welcomecontainer}>
                      <Text style={styles.welcomemessage}>{"Hello,<br/>Nabila".split("<br/>").join("\n")}</Text>
              ...
              <CustomCard elevated={true} style={{backgroundColor:"#fff",marginHorizontal:24,marginTop:-40,padding:30,borderRadius:10,flexDirection:"row",justifyContent:"space-between"}}>
                  <View style={{alignItems:"center"}}>
                    ...
                    <Text style={{fontWeight:"bold",fontSize:18}}>Rp 50.000</Text>
                  </View>
                  <View style={{alignItems:"center"}}>
                    <Text style={{fontWeight:"bold", marginBottom:10}}>Rewards</Text>
                    <Text style={{fontWeight:"bold",fontSize:18}}>Rp 25.000</Text>
                  </View>
                  <View style={{alignItems:"center"}}>
                ...
                <View style={{position:"absolute",bottom:0,width:"100%"}}>
                  <View style={{ flexDirection: "row", justifyContent: "space-between", margin: 26, padding: 10, backgroundColor: "#fff" }}>
                    ...
                    <TouchableOpacity onPress={goToMaps} style={{ alignItems: 'center' }}>
